...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    if (tableView == leftHeaderTableView) {
        ...
        view.backgroundColor = [UIColor colorWithRed:0/255.0f green:31/255.0f blue:112/255.0f alpha:1.0f];
        view.tag = section;
...
- (void)setUpTopHeaderScrollView {
    ...
    for (NSInteger i = 0; i < count; i++) {
        ...
        [label setFont:[UIFont fontWithName:@"HelveticaNeue-CondensedBlack" size:17.0]];
...
- (UITableViewCell *)leftHeaderTableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [label setFont:[UIFont fontWithName:@"Heiti TC" size:17.0]]; // left header label
...
- (UITableViewCell *)contentTableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    for (NSInteger i = 0; i < count; i++) {
        ...
        [label setFont:[UIFont fontWithName:@"Heiti TC" size:17.0]]; // table content text
