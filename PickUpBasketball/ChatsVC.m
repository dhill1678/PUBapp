...
- (IBAction)menuButton:(id)sender {
    ...
    UITableViewController *navController = [self.storyboard instantiateViewControllerWithIdentifier:@"menuController"];
...
- (IBAction)makeGroupButt:(id)sender {
    ...
    NavigationController *navController = [[NavigationController alloc]
                                           initWithRootViewController:chatGroupVC];
    [self presentViewController:navController animated:true completion:nil];
...
#pragma mark - TTABLE VIEW DELEGATES =================================
